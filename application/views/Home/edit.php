	...
	<div id="container" class="container shadow p-3 mb-4 mt-3 bg-white rounded">
		<div class="row">
			<div class="col-sm-10 offset-sm-1">
				<h1 class="text-center pt-4 ">Pemesanan Tiket</h1>
				<div class="info-form"><br>
					...
					<fieldset class="form-group row">
						<?= form_label('Jenis Kelamin', 'gender', 'class="col-form-label col-sm-3 pt-0"') ?><br>
						<!-- <legend class="col-form-label col-sm-3 pt-0">Jenis Kelamin</legend> -->

						<div class="col-sm-8">
							<label for="Laki-laki">
								<?= form_radio('gender', 'Laki-laki', set_radio('gender', 'Laki-laki'), 'id="Laki-laki" class="form-check-inline" ' .  ($penumpang->gender) == 'Laki-laki' ? "checked" : "")?>
								Laki-laki
							</label><br>
							<label for="Perempuan">
								<?= form_radio('gender', 'Perempuan', set_radio('gender', 'Perempuan'), 'id="Perempuan" class="form-check-inline" ' .  ($penumpang->gender) == 'Perempuan' ? "checked" : ""); ?>
								Perempuan
							</label>
						</div>
					</fieldset>
					...
					<div class="text-center">
						<?= form_submit('submitbutton', 'Pesan', 'class="btn btn-primary"') ?>
					</div>
